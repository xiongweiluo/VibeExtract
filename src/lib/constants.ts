...
export const MOCK_DESIGN_TOKENS: DesignTokens = {
  ...
  typographyScale: {
    ...
    steps: [
      { px:'12px', rem:'0.75rem',  lineHeight:'1.5',  weight:'400', letterSpacing:'0px',    role:'label'   },
      { px:'14px', rem:'0.875rem', lineHeight:'1.5',  weight:'400', letterSpacing:'0px',    role:'body-sm' },
      { px:'16px', rem:'1rem',     lineHeight:'1.6',  weight:'400', letterSpacing:'0px',    role:'body'    },
      { px:'20px', rem:'1.25rem',  lineHeight:'1.4',  weight:'500', letterSpacing:'0px',    role:'body-lg' },
      { px:'24px', rem:'1.5rem',   lineHeight:'1.3',  weight:'600', letterSpacing:'-0.5px', role:'h4'      },
      { px:'32px', rem:'2rem',     lineHeight:'1.2',  weight:'700', letterSpacing:'-0.5px', role:'h3'      },
      { px:'48px', rem:'3rem',     lineHeight:'1.1',  weight:'700', letterSpacing:'-1px',   role:'h2'      },
      { px:'56px', rem:'3.5rem',   lineHeight:'1.05', weight:'800', letterSpacing:'-1px',   role:'h1'      },
    ],
  },
};
